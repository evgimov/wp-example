<?php
/**
Template Name: mtp-product-page
 */
get_header(); ?>

<div id="main-content">
    <div style="display: inline-block;"></div>
    <div class="product-mtp-main-container">
        <div class="product-container">
            <div class="product-header">
                <div class="product-description">
                    <h1>МТП04</h1>
                    <p>Система мониторинга<br>трансформаторных подстанций</p>   
                </div>
                <div class="gotoproject">
                    <img src="/wp-content/themes/ivt/img/product-link-icon.png">
                    <ul>
                        <li>Перейти на сайт проекта</li>
                        <li><a href="http://mtp04.ru/">www.mtp04.ru</a></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="product-content-centered">
                    ...
                    <div id="sidebar" class="sidebar-product-container">
                        <div id="secondary" class="sidebar-ivt-news" role="complementary">
                            ...
                            <?php
                                $recent = new WP_Query("cat=9&showposts=3"); 
