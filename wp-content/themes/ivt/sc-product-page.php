<?php
/**
Template Name: sc-product-page
 */
get_header(); ?>

<div id="main-content">
    <div style="display: inline-block;"></div>
    <div class="product-sc-main-container">
        <div class="product-container">
            <div class="product-header">
                <div class="product-description">
                    <h1>Synergy Center</h1>
                    <p>Система управления деятельностью компании<br>и электронным документооборотом</p>   
                </div>
                <div class="gotoproject">
                    <img src="/wp-content/themes/ivt/img/product-link-icon.png">
                    <ul>
                        <li>Перейти на сайт проекта</li>
                        <li><a href="http://s-c.su/">www.s-c.su</a></li>
                    </ul>
                </div>
            </div>
