<?php
/**
Template Name: helios-product-page
 */
get_header(); ?>

<div id="main-content">
    <div style="display: inline-block;"></div>
    <div class="product-helios-main-container">
        <div class="product-container">
            <div class="product-header">
                <div class="product-description">
                    <h1>Асуно Гелиос</h1>
                    <p>Автоматизированная система управления <br> наружным освещением</p>   
                </div>
                <div class="gotoproject">
                    <img src="/wp-content/themes/ivt/img/product-link-icon.png">
                    <ul>
                        <li>Перейти на сайт проекта</li>
                        <li><a href="http://helios.su">www.helios.su</a></li>
                    </ul>
                </div>
            </div>
