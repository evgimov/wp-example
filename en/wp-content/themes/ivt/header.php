            ...
            <div class="site-branding">
             ...
             <div class="select-lang-wrapper">
                <ul>
                    ...
                    <li class="active"><a href="<?php echo get_post_meta($post_id, 'enurl', true);?>">RU</a></li>
                    <?php } elseif (is_front_page()) { ?>
                    <li class="active"><a href="/">RU</a></li>
                    <?php } elseif (in_category('7')) { ?> 
                    <li class="active"><a href="<?php bloginfo('url'); ?>category/helios">RU</a></li>
                    <?php } elseif (in_category('8')) { ?> 
                    <li class="active"><a href="category/synergy-center">RU</a></li> 
                    <?php } elseif (in_category('9')) { ?> 
                    <li class="active"> <a href="category/mtp04">RU</a></li> 
                    <?php } elseif (in_category('10')) { ?> 
                    <li class="active"><a href="category/company">RU</a></li> 
                    <?php } else { ?>
                        <li class="active"><a href="<?php bloginfo('url');?><?php if(isset($args[3]) && !(isset($args[3]))) echo $args[3]; else echo $dd; ?>">RU</a></li>        
                    <?php } ?>
                    <li>EN</li>
                </ul>            
            </div>  
